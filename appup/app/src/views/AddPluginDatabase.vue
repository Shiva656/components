<template>
    <div>
        <div class="page-wrapper adding-plugin-databases triggers-rest">
                ...
                <div class="container clearfix">
                    <div class="page-title float-left">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a :href="`#/app/${$route.params.cloudId}/${$route.params.appId}`">Plugins</a></li>
                                <li class="breadcrumb-item" aria-current="page"><a href="#">Add Plugins</a></li>
                            </ol>
                        </nav>
                        <!-- Breadcrumbs end -->
                    </div> 
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-xl-9 col-md-12">
                            <section class="block clearfix add-plugin-form">
                                <div class="sub-block">
                                    <div class="row">
                                        <div class="col-12">
