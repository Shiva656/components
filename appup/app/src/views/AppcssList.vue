            ...
            <div class="container clearfix">
                    ...
                    <div class="float-left">
                        ...
                        <nav aria-label="breadcrumb" class="breadcrumbs">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="#">appcss</a></li>
                            </ol>
                        </nav>
                        <!-- Breadcrumbs end -->
                ...
                <section class="block triggers-block">
                    ...
                    <div class="clearfix">
                        <nav class="navbar navbar-light float-right mb-3">
                            <form class="form-inline search">
                                <input class="form-control mr-sm-2" type="search" placeholder="Search App CSS" aria-label="Search" @keyup="_trigger('triggers', 'search', `${$event.target.value}`, 'NAME')" /><label></label>
                                <b-button :href="`#/create/new/${$route.params.cloudId}/${$route.params.appId}/${$route.params.entity}`" class="btn my-2 my-sm-0 btn-primary" variant="text-white">Add App CSS</b-button>
                            </form>
                        </nav>
                    </div>
