                    ...
                    <div class="page-title float-left mb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="#">Application Properties</a></li>
                            </ol>
                        </nav>
                        <!-- Breadcrumbs end -->
                    </div> 
                                ...
                                <div class="row">
                                    <div class="col-sm-12">   
                                        <nav class="navbar navbar-light float-right mb-3">
                                           ...
                                           <b-button :href="`#/create/new/${$route.params.cloudId}/${$route.params.appId}/${$route.params.entity}`" class="btn my-2 my-sm-0 btn-primary" variant="text-white">Add Properties</b-button>   
                                            </form>
                                        </nav> 
                                    </div>
                                </div>        
                                <appup-card ref='appproperties' id="1" label="ID" :actions="actions" preload="preload_grid_nofilter"  >
                                    <!-- Slot for sorted key -->
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr v-for="(item, index) in sortedData" :key="index">
                                                                ...
                                                                <td scope="row">
                                                                <a :href="`#/edit/properties/${$route.params.cloudId}/${$route.params.appId}/${$route.params.entity}/${item.ID}`" class="more"> Edit</a>
                                                                <a href="#" @click.prevent="_trigger('appproperties', 'exec', 'prop_grid_delete', {'key': `${item.ID}`, 'keytwo': `Application Properties`, 'entity': `${$route.params.entity}`})" class="more delete-handler"> Delete</a>
                                                                </td>                                                 
                                                            </tr>
                                                        </tbody>                                       
                                                    </table> 
