            ...
            <div class="container clearfix">
                    ...
                    <div class="float-left">
                        ...
                        <nav aria-label="breadcrumb" class="breadcrumbs">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="#">apptheme</a></li>
                            </ol>
                        </nav>
                        <!-- Breadcrumbs end -->
                        ...
                        <div class="btn-group filter second">
                            <div class="dropdown float-right">
                                <b-dropdown id="ddown2" text="Frontend">
                                    ...
                                    <b-dropdown-item  :href="`#/app/appthemelist/${$route.params.cloudId}/${$route.params.appId}/apptheme`">App Themes</b-dropdown-item>
                ...
                <section class="block triggers-block">
                    ...
                    <div class="clearfix">
                        <nav class="navbar navbar-light float-right mb-3">
                            <form class="form-inline search">
                                <input class="form-control mr-sm-2" type="search" placeholder="Search App Theme" aria-label="Search" @keyup="_trigger('triggers', 'search', `${$event.target.value}`, 'NAME')" /><label></label>
                                <b-button :href="`/#/theme-editor/${$route.params.appId}`" class="btn my-2 my-sm-0 btn-primary" variant="text-white" target="_blank">Add APP Theme</b-button>
                            </form>
                        </nav>
                    </div>
                    <appup-card ref='triggers' id="1" label="ID" :actions="actions" preload="preload_theme" >
                        <!-- Slot for sorted key -->
                                        ...
                                        <div class="col-md-12">
                                            <div class="appup_table">
                                                <table class="table">
                                                    ...
                                                    <template v-for="(item, index) in sortedData.themes">
                                                        ...
                                                        <thead v-if="index==0" :key="index+'_thead'">
                                                         ...
                                                         <tbody :key="index+'_tbody'" >
                                                            <tr>
                                                                <td scope="row" v-if="retriveURL(sortedData.pages)">
                                                                    {{index+1}}
                                                                </td>
                                                                <td scope="row">
                                                                ...
                                                                <td scope="row">
                                                                    <a :href="`#/theme-editor/${$route.params.appId}/${item.ID}?url=/runtime/#${appThemeURL}?id=${$route.params.appId}`" class="more" target="_blank">Edit </a>
                                                                    <a @click="_trigger('triggers', 'exec', 'grid_delete_theme', {'key': `${item.ID}`, 'entity': `${$route.params.entity}`})" class="more delete-handler"> Delete</a>
                                                                </td>
                                                            </tr>
                                                        </tbody> 
...
export default {
    ...
    computed: {},
    methods: {
         retriveURL: function(pageData){
            if(pageData[0].URL){
                this.appThemeURL = pageData[0].URL;
                console.log(this.appThemeURL);
            }
            return true;                
        } 
    }
