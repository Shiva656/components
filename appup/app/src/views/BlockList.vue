                    ...
                    <section class="block triggers-block">
                        <nav class="navbar navbar-light float-right mb-3">
                            <form class="form-inline search">
                                ...
                                <template>
                                <b-button :href="`#/create/${$route.params.cloudId}/${$route.params.appId}/block`"  class="btn my-2 my-sm-0 btn-primary" variant="text-white">Add {{$route.params.entity}}</b-button>
                                </template>
                                ...
                                <div class="row">
                                    <template v-for="(item, index) in items">                            
                                        <div class="col-lg-4 col-md-6" :key="index">
                                            ...
                                            <a class="underline-none"  v-if= "item.TYPE == 'FORM'" :href="`#/block/${$route.params.cloudId}/${$route.params.appId}/formEdit/${item.ID}`">
                                                    ...
                                                    <template>
                                                        <div class="dropdown float-right">
                                                            <b-dropdown id="ddown1" text="..." class="outline-more">
                                                                <b-dropdown-item :href="`#/block/${$route.params.cloudId}/${$route.params.appId}/formEdit/${item.ID}`">Edit</b-dropdown-item>
                                            ...
                                            <a class="underline-none" v-else-if="item.TYPE != null" :href="`#/block/${$route.params.cloudId}/${$route.params.appId}/ac-helper/${item.ID}`">
                                                <div class="trigger more-dropdown">
                                                    <div class="trigger-title clearfix">
                                                        <div class="float-left">                                                
                                                        <h4>{{item.NAME}}</h4>                                           
                                                    ...
                                                    <template>
                                                        <div class="dropdown float-right">
                                                            <b-dropdown id="ddown1" text="..." class="outline-more">
                                                                <b-dropdown-item :href="`#/block/${$route.params.cloudId}/${$route.params.appId}/ac-helper/${item.ID}`">Edit</b-dropdown-item>
                                                                <b-dropdown-item @click="_trigger('triggers', 'exec', 'grid_delete', {'key': `${item.ID}`, 'entity': `${$route.params.entity}`})">Delete</b-dropdown-item>
                                                            </b-dropdown>
                                                        </div> 
                                                    </template>
                                             ...
                                             <a class="underline-none" v-else :href="`#/edit/${$route.params.cloudId}/${$route.params.appId}/${$route.params.entity}/${item.ID}`">
                                                <div class="trigger more-dropdown">
                                                    <div class="trigger-title clearfix">
                                                        <div class="float-left">                                                
                                                        <h4>{{item.NAME}}</h4>                                           
