                        ...
                        <div class="float-left">
                            ...
                            <nav aria-label="breadcrumb" class="breadcrumbs">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a :href="`#/app/${$route.params.cloudId}/${$route.params.appId}`">Developers</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="#">{{$route.params.entity}}</a></li>
                                </ol>
                            </nav>
                            <!-- Breadcrumbs end-->
                    ...
                    <section class="block triggers-block">
                        <nav class="navbar navbar-light float-right mb-3">
                            <form class="form-inline search">
                                <input class="form-control mr-sm-2" type="search" placeholder="Search Apps" aria-label="Search"  @keyup="_trigger('triggers', 'search', `${$event.target.value}`, 'NAME')" /><label></label>
