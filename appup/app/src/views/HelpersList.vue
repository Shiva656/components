                        ...
                        <div class="float-left">
                            ...
                            <nav aria-label="breadcrumb" class="breadcrumbs">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="#">Helpers</a></li>
                                </ol>
                            </nav>
                            <!-- Breadcrumbs end -->
                    ...
                    <section class="block triggers-block">
                        <nav class="navbar navbar-light float-right mb-3">
                            <form class="form-inline search">
                                ...
                                <template>
                                <b-button :href="`#/helper/${$route.params.cloudId}/${$route.params.appId}/extentions`"  class="btn my-2 my-sm-0 btn-primary" variant="text-white">Add {{$route.params.entity}}</b-button>
                                </template>
                                    ...
                                    <template v-for="(item, index) in items">                            
                                        <div class="col-lg-4 col-md-6" :key="index">
                                            <template v-if="item.IS_WRITABLE == 1">
                                                <a class="underline-none"  v-if= "item.TYPE == 'FORM'" :href="`#/helper/${$route.params.cloudId}/${$route.params.appId}/formEdit/${item.ID}`">
                                                        ...
                                                        <template>
                                                            <div class="dropdown float-right">
                                                                <b-dropdown id="ddown1" text="..." class="outline-more">
                                                                    <b-dropdown-item :href="`#/helper/${$route.params.cloudId}/${$route.params.appId}/formEdit/${item.ID}`">Edit</b-dropdown-item>
                                                ...
                                                <a class="underline-none" v-else-if="item.TYPE != null" :href="`#/helper/${$route.params.cloudId}/${$route.params.appId}/ac-helper/${item.TYPE}/${item.ID}`">
                                                    <div class="trigger more-dropdown">
                                                        <div class="trigger-title clearfix">
                                                            <div class="float-left">                                                
                                                            <h4>{{item.NAME}}</h4>                                           
                                                        ...
                                                        <template>
                                                            <div class="dropdown float-right">
                                                                <b-dropdown id="ddown1" text="..." class="outline-more">
                                                                    <b-dropdown-item :href="`#/helper/${$route.params.cloudId}/${$route.params.appId}/ac-helper/${item.TYPE}/${item.ID}`">Edit</b-dropdown-item>
                                                                    <b-dropdown-item @click="_trigger('triggers', 'exec', 'grid_delete', {'key': `${item.ID}`, 'entity': `${$route.params.entity}`})">Delete</b-dropdown-item>
                                                                </b-dropdown>
                                                            </div> 
                                                        </template>
