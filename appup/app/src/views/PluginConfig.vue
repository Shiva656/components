                                ...
                                <div class="clearfix">
                                    ...
                                    <nav class="navbar navbar-light float-right mb-3">
                                        <form class="form-inline search">
                                            ...
                                            <b-button :href="`#/app/pluginlist/${$route.params.cloudId}/${$route.params.appId}/plugins`"  class="btn my-2 my-sm-0 btn-primary" variant="text-white">Add Plugins</b-button>
                                        </form>
                                    </nav>
                                    <!-- Search end -->
                                </div>
                                                        ...
                                                        <tbody>
                                                            <tr v-for="(item, index) in sortedData" :key="index">
                                                                ...
                                                                <a :href="`#/edit/plugin/${item.PLUGIN_ID}/config/${$route.params.cloudId}/${$route.params.appId}/${$route.params.entity}/${item.ID}`" class="more"> Edit</a>
                                                                 ...
                                                                 <template v-if="item.IS_WRITABLE != 1">
                                                                <a :href="`#/edittype/plugin/${item.PLUGIN_ID}/config/${$route.params.cloudId}/${$route.params.appId}/${$route.params.entity}/${item.IS_WRITABLE}/${item.ID}`" class="more"> Edit</a>
                                                                </template>
