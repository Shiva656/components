        ...
        <div class="page-wrapper triggers-rest">
            ...
            <div class="page-content">
                <div class="container clearfix">
                    ...
                    <nav class="tab-menu">
                      <ul>
                            <li class="active"><a :href="`#/app/triggerlist/${$route.params.cloudId}/${$route.params.appId}/triggers`">REST</a></li>
                            <li><a :href="`#/trigger/cron/${$route.params.cloudId}/${$route.params.appId}/triggers`">CRON</a></li>
                                                        ...
                                                        <template>
                                                            <div class="dropdown float-right">
                                                                <b-dropdown id="ddown1" text="..." class="outline-more">
                                                                    ...
                                                                    <b-dropdown-item :href="`#/params/swagger/${$route.params.cloudId}/${$route.params.appId}/${item.ID}/${item.WORKFLOW_ID}`">Add Swagger Param</b-dropdown-item>
                                                                </b-dropdown>
                                                            </div> 
                                                        </template>
                                                    </div>
                                                    <div class="trigger-content">
                                                        <template v-if="item.WORKFLOW_ID">
...
export default {
  ...
  computed: {
      top_tabs:function()
      {
          return window.UIJSON.triggers.top_tabs;
      }
  },
  mounted(){
