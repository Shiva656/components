                    ...
                    <div class="float-left">
                        ...
                        <nav aria-label="breadcrumb" class="breadcrumbs">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a :href="`#/app/pagelist/${$route.params.cloudId}/${$route.params.appId}/pages`">Pages</a></li>
                                                    ...
                                                    <template v-for="(item, index) in sortedData">
                                                        ...
                                                        <tbody :key="index+'_tbody'">
                                                            <tr>
                                                                ...
                                                                <td scope="row">
                                                                    <a  target="_blank" :href="`/runtime/#${item.URL}?id=${$route.params.appId}`" class="more">Preview </a>
                                                                    <a :href="`#/usercmsedit/${$route.params.cloudId}/${$route.params.appId}/usercmsitems/${$route.params.ID}/${item.ID}`" class="more">Edit </a>
