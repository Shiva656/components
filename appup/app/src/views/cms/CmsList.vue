        ...
        <div class="container clearfix">
            ...
            <div class="float-left">
              ...
              <nav aria-label="breadcrumb" class="breadcrumbs">
                <ol class="breadcrumb">
                  ...
                  <!-- <li class="breadcrumb-item active" aria-current="page"><a :href="`#/page/${$route.params.cloudId}/${$route.params.appId}/extentions`">Extensions</a></li> -->
                </ol>
              </nav>
              <!-- Breadcrumbs end -->
            </div>
              ...
              <div class="btn-group filter second">
                <div class="dropdown float-right">
                  <b-dropdown id="ddown2" text="Frontend">
                    ...
                    <b-dropdown-item
                      :href="`#/app/handlerlist/${$route.params.cloudId}/${$route.params.appId}/handler`"
          ...
          <section class="block triggers-block">
            ...
            <!-- <div class="clearfix">
                        <nav class="navbar navbar-light float-right mb-3">
                            <form class="form-inline search">
                                <input class="form-control mr-sm-2" type="search" placeholder="Search Cmsitems" aria-label="Search" @keyup="_trigger('triggers', 'search', `${$event.target.value}`, 'NAME')" /><label></label>
                                <b-button :href="`#/create/new/${$route.params.cloudId}/${$route.params.appId}/${$route.params.entity}`" class="btn my-2 my-sm-0 btn-primary" variant="text-white">Add {{$route.params.entity}}</b-button>
                            </form>
                        </nav>
            </div>-->
                              ...
                              <tbody :key="index+'_tbody'">
                                <tr>
                                  ...
                                  <td scope="row">
                                    <a
                                      target="_blank"
                                      :href="`/runtime/#${templatedata.URL}${item.URL}?id=${$route.params.appId}`"
                                      class="more"
                                    >Preview</a>
                                    <a
                                      :href="`#/cmsitemsedit/${$route.params.cloudId}/${$route.params.appId}/cmsitems/${$route.params.ID}/${item.ID}`"
                                      class="more"
                                    >Edit</a>
                                    <a
                                    ...
                                    >Delete</a>
                                      <a
                                      :href="`#/cmsitemsedit/${$route.params.cloudId}/${$route.params.appId}/modifyhelpers/${$route.params.ID}/${item.ID}`"
                                      class="more"
                                    >Modify</a>
                                  </td>
                                </tr>
...
export default {
    ...
    data() {
        return {
            ...
            templatedata:"",
            userURL:"/appdb/_db/PAGE_TEMPLATE?where=id="+this.$route.params.ID+" or APPLICATION_ID=0001"
        };
    },
    created: function () {
    var _self=this;
    _self.$appupajax.get2(_self.userURL, {}, {}, {withCredentials: true, credentials: "include" })
    // _self.$appupajax
    //     .get2(
    //      "/appdb/_db/PAGE_TEMPLATE?where=id="+this.$route.params.ID+" or APPLICATION_ID=0001",
    //       {},
    ...
    //     )
        ...
        .then(response => {
          debugger;
          _self.templatedata=response.data[0];
        })
