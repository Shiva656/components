...
<div v-if="isFixedHeader">
  <div class="vuetable-head-wrapper">
    ...
    <thead v-if="isHeader? true : false">
      <tr>
...
export default {
  ...
  methods: {
    ...
    loadData (success = this.loadSuccess, failed = this.loadFailed) {
      ...
      this.httpOptions['credentials'] = "include";
    ...
    loadSuccess (response) {
      ...
      if (this.tablePagination === null) {
        this.warn('table: pagination-path "' + this.paginationPath + '" not found. '
    ...
    toggleCheckbox (dataItem, fieldName, event) {
      ...
      this.$emit('checkbox-toggled', isChecked, dataItem)
    },
    selectId (key) {
    ...
    toggleAllCheckboxes (fieldName, event) {
      ...
      this.$emit('checkbox-toggled-all', isChecked)
    },
    gotoPreviousPage () {
