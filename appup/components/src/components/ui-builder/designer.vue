...
function receiveMessage(event) {
  if (typeof event.data == "object") {
    ...
    if ("command" in data) {
      ...
      designer_serialized_json = data["builder_json"];
    }
  }
}
...
export default {
  ...
  methods: {
    ...
    get_json: function() {
      ...
      return designer_serialized_json;
    },
    save: async function() {
      debugger;
      // Reset global workflow json variable
      //   designer_serialized_json = undefined;
      ...
      while (!designer_serialized_json && this.checkMax(start)) {
        console.log("Sleeping...");
        await this.sleep(5); // 5 milliseconds
      }

      console.log("Awake!!");
      console.log(designer_serialized_json);
    },
    sleep: function(ms) {
